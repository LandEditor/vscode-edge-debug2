...
export function isEdgeDebuggingSupported(): boolean {
	...
	return (
		...
		(majorVersion === 10 && minorVersion === 0 && buildNumber >= 17058)
	); // RS4 or higher
}
...
export const targetFilter: chromeConnection.ITargetFilter = (target) =>
	target &&
	(!target.type || target.type === "page" || target.type === "Page");
